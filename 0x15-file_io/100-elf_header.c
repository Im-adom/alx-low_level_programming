...
/**
 * print_type - This function prints the type of ELF header.
 * @e_type: The ELF type we want to print.
 * @e_ident: A pointer to an array containing the ELF class.
 */
void print_type(unsigned int e_type, unsigned char *e_ident)
{
...
/**
 * close_elf - This function closes an opened ELF file.
 ...
 * Return: 0.
 * Description: If the funtion fails- exit code: 98.
